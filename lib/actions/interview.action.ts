...
import { feedbackSchema } from "../zodSchema";
import { CREDIT_COSTS, ONE_WEEK_IN_SECONDS } from "@/constants";
...
export async function _createInterviewFeedback(params: CreateFeedbackParams) {
...
export const createInterviewFeedbackAction = cache(
  _createInterviewFeedback,
  (params) =>
    createHash({
  ...
  { keyPrefix: "interview-feedback", expiration: ONE_WEEK_IN_SECONDS }
);
