...
**Leo:** Hey hey hey! What’s up, everybody?
...
**Gwen:** and you know exactly when to add the garlic.
...
**Gwen:** remember grammar, pronounce things, and do it all quickly.
...
**Leo:** and then try to turn it into English word by word.
