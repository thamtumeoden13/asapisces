      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Practice English conversation with AI companions using advanced voice recognition and real-time feedback
          </p>
        </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600">{completedTopics.size}</div>
                <div className="text-sm text-gray-600">Topics Completed</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600">{getTopicProgress().toFixed(0)}%</div>
                <div className="text-sm text-gray-600">Overall Progress</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600">{Object.keys(podcastTopics).length}</div>
                <div className="text-sm text-gray-600">Total Topics</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-600">{userLevel}</div>
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-4">
              ...
              <CardContent className="space-y-6">
                ...
                {/* Topic Selection */}
                <div>
                  <label className="text-sm font-medium mb-3 block">Choose Topic</label>
                        ...
                        >
                          <div className="flex items-center justify-between w-full">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <Badge variant={getTopicBadgeVariant(topicKey)} className="text-xs">
                ...
                <div className="pt-4 border-t">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span>Remaining:</span>
                      <span className="font-medium">{Object.keys(podcastTopics).length - completedTopics.size}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Progress:</span>
                      <span className="font-medium">{getTopicProgress().toFixed(0)}%</span>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Select from various conversation topics based on your learning goals and interests.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Engage in natural conversation with AI companions using advanced voice recognition.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Receive instant feedback on pronunciation, fluency, and conversation skills.
                </p>
              </div>
            </div>
          </CardContent>
